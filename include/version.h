...
#define V64TNG_VERSION_DATE_CODE 914
#define V64TNG_VERSION_DAILY_BUILD 3
#define V64TNG_VERSION_STRING "1.0.20260914.3"
#define V64TNG_VERSION_WSTRING L"1.0.20260914.3"
...
#define V64TNG_FILE_VERSION 1,0,2026,25703
