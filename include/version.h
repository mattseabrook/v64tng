...
#define V64TNG_VERSION_DAILY_BUILD 26
#define V64TNG_VERSION_STRING "1.0.20260904.26"
#define V64TNG_VERSION_WSTRING L"1.0.20260904.26"
...
#define V64TNG_FILE_VERSION 1,0,2026,24726
