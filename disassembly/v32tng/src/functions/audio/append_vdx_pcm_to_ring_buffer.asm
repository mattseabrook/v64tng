...
; Static + caller decode_vdx_stream at 0040C593h. Copies (source,length) bytes into 64 KiB buffer
; [0042143Ch], wrapping write offset 0041F50Ch at 10000h. No-op without digital driver 0041F4E8h.
; On first append resets timer 0041F524h to -4 via InterlockedExchange and sets active flag
; 0041F510h. Adds length to queued total 0041F51Ch; no capacity check here.
; Generated losslessly; preserve byte identity after edits.

%macro emit_append_vdx_pcm_to_ring_buffer_part_00 0
    %%fragment_start:
append_vdx_pcm_to_ring_buffer:
    %%insn_00406d8e:
