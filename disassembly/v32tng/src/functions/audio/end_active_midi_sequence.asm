...
; Verified Miles AIL wrapper: end the active sequence handle when one exists.
; Generated losslessly; preserve byte identity after edits.

%macro emit_end_active_midi_sequence_part_00 0
    %%fragment_start:
end_active_midi_sequence:
    %%insn_0040712c:
    ...
    %%insn_0040713e:
    call dword near [0x4245e4] ; 0040713E FF15E4454200 | _AIL_end_sequence@4
    %if ($ - %%insn_0040713e) > 6
        %error "LONG_0040713E"
    %endif
