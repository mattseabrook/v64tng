...
; Static + caller finalize_vdx_stream_playback at 0040C732h. If active, reset 0041F524h then poll
; _AIL_sample_buffer_info@20 (IAT 004245FCh). Exit requires at least 10 ticks and either returned
; position/length pair equal (OR, not AND). Resets active flag, read/write offsets and byte totals
; at 0041F50Ch..0041F520h. The tick threshold is a minimum, not a timeout; do not label this as
; bounded waiting.
; Generated losslessly; preserve byte identity after edits.

%macro emit_wait_sample_buffer_boundary_and_reset_part_00 0
    %%fragment_start:
wait_sample_buffer_boundary_and_reset:
    %%insn_00406fae:
