...
; Verified Miles AIL Red Book selection used by GRV PLAYCD.
; Waits for the current track to stop, resolves track bounds, and starts playback.
; Selection 3 maps to track 2 with a 155CC0h start offset; 62h stops prior selection 3.
; Generated losslessly; preserve byte identity after edits.

%macro emit_play_redbook_selection_part_00 0
    %%fragment_start:
play_redbook_selection:
    %%insn_004071f2:
    ...
    %%insn_00407229:
    call dword near [0x4245cc] ; 00407229 FF15CC454200 | _AIL_redbook_stop@4
    %if ($ - %%insn_00407229) > 6
        %error "LONG_00407229"
    %endif
    ...
    %%insn_00407239:
    call get_active_redbook_track ; 00407239 E896FFFFFF
    %if ($ - %%insn_00407239) > 5
        %error "LONG_00407239"
    %endif
    ...
    %%insn_0040725f:
    call dword near [0x4245d0] ; 0040725F FF15D0454200 | _AIL_redbook_track_info@16
    %if ($ - %%insn_0040725f) > 6
        %error "LONG_0040725F"
    %endif
    ...
    %%insn_00407286:
    call dword near [0x424634] ; 00407286 FF1534464200 | _AIL_redbook_play@12
    %if ($ - %%insn_00407286) > 6
        %error "LONG_00407286"
    %endif
