...
; Verified Miles Sound System startup: opens Red Book device 0 and configures digital/MIDI audio.
; Generated losslessly; preserve byte identity after edits.

%macro emit_initialize_miles_audio_system_part_00 0
    %%fragment_start:
initialize_miles_audio_system:
    %%insn_00407302:
    ...
    %%insn_00407305:
    call dword near [0x424628] ; 00407305 FF1528464200 | _AIL_startup@0
    %if ($ - %%insn_00407305) > 6
        %error "LONG_00407305"
    %endif
    ...
    %%insn_0040730d:
    call dword near [0x4245d8] ; 0040730D FF15D8454200 | _AIL_redbook_open@4 (device 0)
    %if ($ - %%insn_0040730d) > 6
        %error "LONG_0040730D"
    %endif
