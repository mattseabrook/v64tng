...
; Static + teardown caller 004013FFh. Iterates exactly 21 (size,pointer) entries at 004223A0h,
; passing each nonnull pointer at entry+4 to free (0040C9A0h). Does not zero pointers/sizes or
; free the separate resource-flag allocation; not an idempotent clear operation.
; Generated losslessly; preserve byte identity after edits.

%macro emit_free_rl_index_buffers_part_00 0
    %%fragment_start:
free_rl_index_buffers:
    %%insn_00401161:
