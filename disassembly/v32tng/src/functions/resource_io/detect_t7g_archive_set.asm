...
; Verified GETCD implementation. Searches C: through Z: for \t7g\b.gjd, then \t7g\at.gjd.
; Returns 1 for B.GJD, 2 for AT.GJD, or FFh when neither path can be opened.
; It checks only file availability: no volume label, disc identity, signature, hash, or registry state.
; Generated losslessly; preserve byte identity after edits.

%macro emit_detect_t7g_archive_set_part_00 0
    %%fragment_start:
detect_t7g_archive_set:
    %%insn_00402172:
    ...
    %%insn_0040217c:
    push dword v32_getcd_b_gjd_path ; 0040217C 6884B14100
    %if ($ - %%insn_0040217c) > 5
        %error "LONG_0040217C"
    %endif
    times 5 - ($ - %%insn_0040217c) db 0
    %%insn_00402181:
    call open_first_drive_letter_path ; 00402181 E82DFAFFFF
    %if ($ - %%insn_00402181) > 5
        %error "LONG_00402181"
    %endif
    ...
    %%insn_004021a4:
    push dword v32_getcd_at_gjd_path ; 004021A4 6894B14100
    %if ($ - %%insn_004021a4) > 5
        %error "LONG_004021A4"
    %endif
    times 5 - ($ - %%insn_004021a4) db 0
    %%insn_004021a9:
    call open_first_drive_letter_path ; 004021A9 E805FAFFFF
    %if ($ - %%insn_004021a9) > 5
        %error "LONG_004021A9"
    %endif
