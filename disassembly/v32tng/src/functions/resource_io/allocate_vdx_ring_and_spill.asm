...
; Allocate30000h bytes; set ring[0041F5F4h] to allocation and spill[00420A00h] to
; allocation+20000h. The main ring is128KiB; final64KiB make wrapped reads contiguous. Replaces
; the overly broad game-state initialization label.
; Generated losslessly; preserve byte identity after edits.

%macro emit_allocate_vdx_ring_and_spill_part_00 0
    %%fragment_start:
allocate_vdx_ring_and_spill:
    %%insn_00409a90:
