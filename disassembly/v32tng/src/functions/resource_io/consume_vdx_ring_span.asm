...
; Static + machine-code boundary tests. Returns ring+old reader for requested length, subtracts
; length from available count, increments consumption counter00420A14h. If reader+length
; >20000h, copies wrapped head bytes into spill area[00420A00h]=ring+20000h and stores wrapped
; reader. Equality deliberately leaves reader=20000h; next positive request copies entirely into
; spill. Allocation has10000h spill bytes. No bounds/availability checks in this helper.
; Generated losslessly; preserve byte identity after edits.

%macro emit_consume_vdx_ring_span_part_00 0
    %%fragment_start:
consume_vdx_ring_span:
    %%insn_00409e85:
    ...
    %%insn_00409ed6:
    call copy_memory_overlap_safe ; 00409ED6 E8352B0000
    %if ($ - %%insn_00409ed6) > 5
        %error "LONG_00409ED6"
    %endif
