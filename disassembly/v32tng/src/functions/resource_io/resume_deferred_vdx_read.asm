...
; Static + machine-code tests. If 0041F5ECh holds a deferred cache handle, seek [004209FCh] to
; its continuation offset through seek_to_cached_resource_offset, clear deferred handle, enable
; refills at 00420A08h. Otherwise no-op. Called by decode_vdx_stream at 0040C2B4h.
; Generated losslessly; preserve byte identity after edits.

%macro emit_resume_deferred_vdx_read_part_00 0
    %%fragment_start:
resume_deferred_vdx_read:
    %%insn_00409d1e:
    ...
    %%insn_00409d37:
    call seek_to_cached_resource_offset ; 00409D37 E8B2060000
    %if ($ - %%insn_00409d37) > 5
        %error "LONG_00409D37"
    %endif
