...
; Static + normal-path machine-code tests. If enabled and available bytes <20000h, derive
; contiguous free space from reader 0041F5E8h and writer 0041F5F0h. Non-wrapped free spans
; below4000h return immediately; wrapped tail fragments may be smaller. Read at most4000h into
; ring+writer, advance writer modulo20000h, add REQUESTED count to availability00420A10h
; regardless of mmioRead result. Calls _AIL_background except on the insufficient non-wrapped-
; space exit. Caller includes media pacing at00406F39h.
; Generated losslessly; preserve byte identity after edits.

%macro emit_service_vdx_read_ring_part_00 0
    %%fragment_start:
service_vdx_read_ring:
    %%insn_00409d64:
...
%macro emit_service_vdx_read_ring_part_01 0
    %%fragment_start:
    %%insn_00409e34:
