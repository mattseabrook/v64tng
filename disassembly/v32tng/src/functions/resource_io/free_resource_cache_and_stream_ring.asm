...
; Static + controlled-free machine-code test. Iterates all 256 twenty-byte cache entries,
; freeing nonnull data pointers at 0041F5F8h+20*i, then frees resource flags [00422448h] and
; ring allocation [0041F5F4h]. Does not clear pointers/counts. Called by shutdown at 00408F27h.
; Generated losslessly; preserve byte identity after edits.

%macro emit_free_resource_cache_and_stream_ring_part_00 0
    %%fragment_start:
free_resource_cache_and_stream_ring:
    %%insn_00409ab6:
