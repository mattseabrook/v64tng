...
; Static + machine-code check. Writes zero to byte [00422448h]+resource_id argument. Cache
; insertion/eviction at 00409F1Ah and 0040A29Fh call it when discarding a block. Flag array is
; separately allocated as 10000h bytes by load_rl_indexes_and_initialize_resource_flags. No
; range check here.
; Generated losslessly; preserve byte identity after edits.

%macro emit_clear_resource_cache_flag_part_00 0
    %%fragment_start:
clear_resource_cache_flag:
    %%insn_00409f0a:
