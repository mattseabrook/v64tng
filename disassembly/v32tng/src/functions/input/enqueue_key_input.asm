...
; Static + paired dequeue_key_input 004069E5h + exhaustive machine-code head/tail tests. 64-byte
; circular buffer at 0041F478h; read index 0041F4B8h, write index 0041F4BCh. If next write index
; equals read index, return AL=FFh and leave storage untouched. Otherwise enqueue low byte of
; argument, advance modulo 64, return AL=0. Capacity is 63 bytes. Caller v32_window_procedure at
; 0040902Dh.
; Generated losslessly; preserve byte identity after edits.

%macro emit_enqueue_key_input_part_00 0
    %%fragment_start:
enqueue_key_input:
    %%insn_00406a48:
