...
; Static imports + controlled-clock machine-code tests. deadline=timeGetTime()+argument (32-bit
; wrapping addition); do Sleep(1) while unsigned timeGetTime()<deadline. IAT
; 0042458Ch/004244CCh. Even duration zero sleeps once. Absolute comparison is not wrap-safe:
; start FFFFFFFEh, duration 5 exits after one sleep instead of five.
; Generated losslessly; preserve byte identity after edits.

%macro emit_sleep_until_multimedia_deadline_part_00 0
    %%fragment_start:
sleep_until_multimedia_deadline:
    %%insn_004015bf:
