...
; Static + machine-code tests of alignment/length and overlapping ranges. Conventional cdecl
; (destination,source,count): EDI from arg1, ESI from arg2. Copies backward if destination lies
; inside the source range, otherwise forward; returns destination. Important evidence for GRV22h
; versus37h copy directions. Behavioral name does not claim original C-library symbol spelling.
; Generated losslessly; preserve byte identity after edits.

%macro emit_copy_memory_overlap_safe_part_00 0
    %%fragment_start:
copy_memory_overlap_safe:
    %%insn_0040ca10:
...
%macro emit_copy_memory_overlap_safe_part_01 0
    %%fragment_start:
    %%insn_0040ca6c:
...
%macro emit_copy_memory_overlap_safe_part_02 0
    %%fragment_start:
...
%macro emit_copy_memory_overlap_safe_part_03 0
    %%fragment_start:
...
%macro emit_copy_memory_overlap_safe_part_04 0
    %%fragment_start:
...
%macro emit_copy_memory_overlap_safe_part_05 0
    %%fragment_start:
    %%insn_0040cb0c:
...
%macro emit_copy_memory_overlap_safe_part_06 0
    %%fragment_start:
    %%insn_0040cb68:
...
%macro emit_copy_memory_overlap_safe_part_07 0
    %%fragment_start:
    %%insn_0040cb70:
...
%macro emit_copy_memory_overlap_safe_part_08 0
    %%fragment_start:
    %%insn_0040cb7c:
...
%macro emit_copy_memory_overlap_safe_part_09 0
    %%fragment_start:
    %%insn_0040cb90:
...
%macro emit_copy_memory_overlap_safe_part_10 0
    %%fragment_start:
    %%insn_0040cba8:
...
%macro emit_copy_memory_overlap_safe_part_11 0
    %%fragment_start:
    %%insn_0040cbd0:
...
%macro emit_copy_memory_overlap_safe_part_12 0
    %%fragment_start:
...
%macro emit_copy_memory_overlap_safe_part_13 0
    %%fragment_start:
    %%insn_0040cc08:
...
%macro emit_copy_memory_overlap_safe_part_14 0
    %%fragment_start:
    %%insn_0040cc28:
...
%macro emit_copy_memory_overlap_safe_part_15 0
    %%fragment_start:
    %%insn_0040cc50:
...
%macro emit_copy_memory_overlap_safe_part_16 0
    %%fragment_start:
    %%insn_0040cca4:
...
%macro emit_copy_memory_overlap_safe_part_17 0
    %%fragment_start:
    %%insn_0040cd00:
...
%macro emit_copy_memory_overlap_safe_part_18 0
    %%fragment_start:
    %%insn_0040cd08:
...
%macro emit_copy_memory_overlap_safe_part_19 0
    %%fragment_start:
    %%insn_0040cd18:
...
%macro emit_copy_memory_overlap_safe_part_20 0
    %%fragment_start:
    %%insn_0040cd2c:
