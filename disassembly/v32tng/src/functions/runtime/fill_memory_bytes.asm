...
; Static + machine-code tests across lengths/alignment. cdecl(destination,value,count), fills
; low byte of value, returns destination. Aligns to dword writes then fills tail; count zero
; performs no writes. Used for palette/display/ring initialization. No claim about original
; C-runtime symbol spelling.
; Generated losslessly; preserve byte identity after edits.

%macro emit_fill_memory_bytes_part_00 0
    %%fragment_start:
fill_memory_bytes:
    %%insn_0040d470:
