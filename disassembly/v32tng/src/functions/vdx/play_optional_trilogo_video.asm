...
; Verified optional trilogo.vdx launcher. Opens the loose file from the current
; directory and begins playback only when the open succeeds.
; Generated losslessly; preserve byte identity after edits.

%macro emit_play_optional_trilogo_video_part_00 0
    %%fragment_start:
play_optional_trilogo_video:
    %%insn_00401c99:
    ...
    %%insn_00401ca3:
    push dword v32_trilogo_filename ; 00401CA3 6820B14100
    %if ($ - %%insn_00401ca3) > 5
        %error "LONG_00401CA3"
    %endif
