...
; Verified VDX audio/pacing service. Refills an active Miles sample buffer,
; advances the 100 ms Red Book or 40 ms silent pacing deadline, pumps media,
; and waits until timeGetTime reaches that deadline.
; Generated losslessly; preserve byte identity after edits.

%macro emit_service_vdx_audio_and_wait_for_pacing_part_00 0
    %%fragment_start:
service_vdx_audio_and_wait_for_pacing:
    %%insn_00406e28:
    ...
    %%insn_00406f56:
    movsx edx,word [v32_vdx_redbook_track_snapshot] ; 00406F56 0FBF154C0E4200
    %if ($ - %%insn_00406f56) > 7
        %error "LONG_00406F56"
    %endif
    ...
    %%insn_00406f67:
    mov eax,[v32_vdx_next_pacing_deadline_ms] ; 00406F67 A1E0F44100
    %if ($ - %%insn_00406f67) > 5
        %error "LONG_00406F67"
    %endif
    ...
    %%insn_00406f84:
    mov eax,[v32_vdx_next_pacing_deadline_ms] ; 00406F84 A1E0F44100
    %if ($ - %%insn_00406f84) > 5
        %error "LONG_00406F84"
    %endif
    ...
    %%insn_00406f8c:
    mov [v32_vdx_next_pacing_deadline_ms],eax ; 00406F8C A3E0F44100
    %if ($ - %%insn_00406f8c) > 5
        %error "LONG_00406F8C"
    %endif
    ...
    %%insn_00406fa4:
    mov [v32_vdx_next_pacing_deadline_ms],ecx ; 00406FA4 890DE0F44100
    %if ($ - %%insn_00406fa4) > 6
        %error "LONG_00406FA4"
    %endif
