...
; Verified role (static + machine-code evidence):
; CORRECTED DIRECTION, verified by actual copy_memory_overlap_safe execution:
; memcpy([004212D0h], [0042133Ch]+0C800h, 32000h). GRV22h snapshots display rows80..399 into the
; saved320-row buffer. GRV37h at0040A7AAh copies in the opposite direction. Earlier background-
; to-foreground label reversed the arguments.
; Generated losslessly; preserve byte identity after edits.

%macro emit_snapshot_display_band_to_saved_background_part_00 0
    %%fragment_start:
snapshot_display_band_to_saved_background:
    %%insn_0040a786:
    ...
    %%insn_0040a7a0:
    call copy_memory_overlap_safe ; 0040A7A0 E86B220000
    %if ($ - %%insn_0040a7a0) > 5
        %error "LONG_0040A7A0"
    %endif
