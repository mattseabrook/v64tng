...
; Verified PLAYCD-2 prelude: open loose "vielogo.vdx" and start its VDX playback.
; Returns AX=1 when the loose file opened and playback was started, otherwise AX=0.
; Generated losslessly; preserve byte identity after edits.

%macro emit_play_optional_vielogo_video_part_00 0
    %%fragment_start:
play_optional_vielogo_video:
    %%insn_00401c55:
    ...
    %%insn_00401c5f:
    push dword v32_vielogo_filename ; 00401C5F 6814B14100
    %if ($ - %%insn_00401c5f) > 5
        %error "LONG_00401C5F"
    %endif
    times 5 - ($ - %%insn_00401c5f) db 0
    %%insn_00401c64:
    call dword near [0x424598] ; 00401C64 FF1598454200 | WINMM mmioOpenA
    %if ($ - %%insn_00401c64) > 6
        %error "LONG_00401C64"
    %endif
