...
; Static + DOS counterpart 0400Ah. Argument low word == 1 selects unsigned byte at script base
; 0041F284h + PC 0041F300h and advances PC by one; all other values call grv_read_u16_le at
; 00401473h. Returns index in AX; upper EAX is not an API result. The VM derives the argument from
; raw opcode bit 7.
; Generated losslessly; preserve byte identity after edits.

%macro emit_grv_read_variable_operand_part_00 0
    %%fragment_start:
grv_read_variable_operand:
    %%insn_004017ee:
