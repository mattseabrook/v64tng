...
; Static + machine-code tests. Writes the three complete 16-bit PRNG state words at
; 0041F4C0h/4C4h/4C8h through three caller-supplied pointers. These words can exceed FFh after
; advancement; do not truncate this export to bytes. No claim of a reachable game caller is
; made.
; Generated losslessly; preserve byte identity after edits.

%macro emit_read_grv_random_state_part_00 0
    %%fragment_start:
read_grv_random_state:
    %%insn_00406ae9:
