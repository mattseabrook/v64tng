...
; Static: memset([0042133Ch],0,0C800h) clears 640*80 foreground bytes; sets presentation bounds
; x=0..640,y=0..80 and dirty flag 0041F590h=1. Caller run_grv_vm at 00402A6Ch. Foreground pointer
; independently identified by COPY_BG_TO_FG at 0040A786h.
; Generated losslessly; preserve byte identity after edits.

%macro emit_clear_grv_top_bar_part_00 0
    %%fragment_start:
clear_grv_top_bar:
    %%insn_0040a73a:
    ...
    %%insn_0040a74a:
    call fill_memory_bytes ; 0040A74A E8212D0000
    %if ($ - %%insn_0040a74a) > 5
        %error "LONG_0040A74A"
    %endif
