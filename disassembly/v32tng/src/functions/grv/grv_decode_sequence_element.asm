...
; Static + DOS 04016h correspondence + machine-code tests. Decode from script [0041F284h]+PC
; [0041F300h], returning value in AL. Literal (token&7Fh)-30h; #letter selects variable
; (letter&7Fh)-61h; |row,column selects variable 19h+10*row+column. Supports # substitutions for
; each coordinate. Row byte/substitution letter is intentionally unmasked; terminal bit is
; masked on column. Operands advance PC; no bank bounds checks. Unlike DOS, this helper does not
; return a last-byte/termination flag.
; Generated losslessly; preserve byte identity after edits.

%macro emit_grv_decode_sequence_element_part_00 0
    %%fragment_start:
grv_decode_sequence_element:
    %%insn_004015e6:
