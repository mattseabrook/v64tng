...
; Static + machine-code tests. Argument low word == 1 reads a byte index and advances PC by one;
; otherwise calls grv_read_u16_le. Dereferences that index in [0041F2B8h] and returns AL.
; Contrast grv_read_variable_operand at 004017EEh, which returns the index in AX. No bounds
; check.
; Generated losslessly; preserve byte identity after edits.

%macro emit_grv_read_variable_value_part_00 0
    %%fragment_start:
grv_read_variable_value:
    %%insn_0040179b:
