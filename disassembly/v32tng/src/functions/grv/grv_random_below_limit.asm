...
; Static + machine-code tests. Calls advance_grv_random_state at 00406B14h and keeps AX. For
; limit == 1 returns AX & 1 (0 OR 1). Otherwise masks to low byte and repeatedly subtracts limit
; while value >= limit. For limits 2..256 this is low-byte modulo limit. Limit zero does not
; terminate. Caller run_grv_vm at 00402E0Ch.
; Generated losslessly; preserve byte identity after edits.

%macro emit_grv_random_below_limit_part_00 0
    %%fragment_start:
grv_random_below_limit:
    %%insn_00401572:
    ...
    %%insn_00401576:
    call advance_grv_random_state ; 00401576 E899550000
    %if ($ - %%insn_00401576) > 5
        %error "LONG_00401576"
    %endif
