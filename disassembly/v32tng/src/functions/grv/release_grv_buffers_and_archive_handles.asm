...
; Static + shutdown caller 00408F1Dh. Frees nonnull globals 0041F284h (script), 0041F2B8h
; (variables), 0041F304h (VM stack), 0041F280h, 0041F2ECh (saved locals), 0041F2A4h; then frees
; RL indexes and closes nonzero mmio handles 0041F2F8h/0041F2D4h. Resets cached archive IDs
; 0041F2E8h/0041F2B0h to -1. Does not null freed pointers or closed handles. Allocation
; correspondence: initialize_grv_runtime_and_load_script 00401202h and load_grv_script_file
; 004011A3h.
; Generated losslessly; preserve byte identity after edits.

%macro emit_release_grv_buffers_and_archive_handles_part_00 0
    %%fragment_start:
release_grv_buffers_and_archive_handles:
    %%insn_0040136e:
    ...
    %%insn_004013ff:
    call free_rl_index_buffers ; 004013FF E85DFDFFFF
    %if ($ - %%insn_004013ff) > 5
        %error "LONG_004013FF"
    %endif
