...
; Static + machine-code tests. Splits low 24 bits of the argument into zero-extended words at
; 0041F4C0h, 0041F4C4h, 0041F4C8h (low byte first). Ignores top eight bits. RL initializer calls
; it with timeGetTime. Seed zero is accepted here; the advance routine substitutes its fallback
; later.
; Generated losslessly; preserve byte identity after edits.

%macro emit_seed_grv_random_state_part_00 0
    %%fragment_start:
seed_grv_random_state:
    %%insn_00406ab0:
