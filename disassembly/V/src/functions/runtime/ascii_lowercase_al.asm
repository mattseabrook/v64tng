...
; Static: only AL in inclusive ASCII A..Z is ORed with 20h; all other values unchanged. Caller
; 04FF6h applies this to both string bytes. No locale handling.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_ascii_lowercase_al_part_00 0
    %%fragment_start:
ascii_lowercase_al:
    %%insn_04feb:
