...
; Static: compare zero-terminated strings at DS:SI and ES:DI after ASCII folding with 04FEBh.
; Preserve SI/DI; return comparison FLAGS, not a signed integer. Both zero bytes terminate equal;
; otherwise stop at first folded mismatch.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_compare_ascii_strings_case_insensitive_part_00 0
    %%fragment_start:
compare_ascii_strings_case_insensitive:
    %%insn_04ff6:
    push di ; 04FF6 57
    %if ($ - %%insn_04ff6) > 1
        %error "LONG_04FF6"
    ...
    %%insn_05001:
    call ascii_lowercase_al ; 05001 E8E7FF
    %if ($ - %%insn_05001) > 3
        %error "LONG_05001"
    %endif
    ...
    %%insn_05006:
    call ascii_lowercase_al ; 05006 E8E2FF
    %if ($ - %%insn_05006) > 3
        %error "LONG_05006"
    %endif
