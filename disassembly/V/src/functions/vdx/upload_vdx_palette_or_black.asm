...
; Verified role (static): upload 256 RGB entries to the VGA DAC, or black
; the staging palette when CF4Ch bit 0 requests a subsequent fade-in.
; CF20h == 0 and D9FAh == 2 suppress the operation. Both upload paths wait
; for a fresh vertical retrace via port 03DAh bit 3, then write 768 bytes
; through 03C8h/03C9h. Source palette: CF8Ch; black staging palette: CB20h.
; Callers: decode_vdx_bitmap_still, including 00843h and 00DC4h.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_upload_vdx_palette_or_black_part_00 0
    %%fragment_start:
upload_vdx_palette_or_black:
    %%insn_00501:
