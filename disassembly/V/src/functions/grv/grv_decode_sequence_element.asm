...
; Decode one sequence element from DS:SI; return value AL and last encoded byte DH (bit 7
; terminates a sequence). Literal: (token & 7Fh)-30h. #letter reads SS:DBA2h+(letter-61h).
; |row,column reads SS:DBBBh+10*row+column, allowing # substitutions. Preserves BX/CX. Callers
; include LOADSTRING and all sequence comparisons.
