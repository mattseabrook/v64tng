...
; Opcode 25h caller 03C88h. Destination index uses raw opcode width; source index always LODSW.
; Adds source variable byte to destination modulo 256 in SS:DBA2h bank.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_grv_add_variable_part_00 0
    %%fragment_start:
grv_add_variable:
    %%insn_040c7:
    call grv_read_variable_operand ; 040C7 E840FF
    %if ($ - %%insn_040c7) > 3
        %error "LONG_040C7"
    %endif
