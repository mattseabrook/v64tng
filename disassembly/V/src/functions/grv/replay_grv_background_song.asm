...
; Preserves DS/general registers, restores engine DS=0893h, loads SS:E029h and subtracts one,
; marks CF2Eh, then calls select_grv_song_resource at 03941h and 05BD1h. Counterpart to opcode 08h
; setter at 0444Ah; no unset-sentinel guard inside this helper.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_replay_grv_background_song_part_00 0
    %%fragment_start:
replay_grv_background_song:
    %%insn_046f5:
    push ds ; 046F5 1E
    %if ($ - %%insn_046f5) > 1
        %error "LONG_046F5"
