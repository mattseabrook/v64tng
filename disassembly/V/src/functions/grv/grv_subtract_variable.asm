...
; Opcode 41h caller 03C92h. Destination index uses raw opcode width; source index always LODSW.
; Subtracts source variable byte from destination modulo 256.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_grv_subtract_variable_part_00 0
    %%fragment_start:
grv_subtract_variable:
    %%insn_040df:
    call grv_read_variable_operand ; 040DF E828FF
    %if ($ - %%insn_040df) > 3
        %error "LONG_040DF"
    %endif
