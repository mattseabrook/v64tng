...
; Opcode 18h caller 03B1Ah. Increment call depth at SS:DE27h; store SI+2 into SS:DE27h+2*depth;
; jump to the little-endian word at DS:SI. Return stack is distinct from the x86 CPU stack.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_grv_call_absolute_part_00 0
    %%fragment_start:
grv_call_absolute:
    %%insn_04461:
