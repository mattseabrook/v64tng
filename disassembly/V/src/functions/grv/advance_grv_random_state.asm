...
; Advances three bytes SS:D9FFh/DA00h/DA01h through 16 rounds of RCR/XOR/RCL feedback; writes
; updated state and returns final low state byte in AH. Preserves AL/CX/DX. This is stateful
; feedback, not a hardware entropy read; original polynomial naming is not inferred.
