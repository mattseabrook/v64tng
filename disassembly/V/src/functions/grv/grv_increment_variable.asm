...
; Opcode 1Fh caller 03BE4h. Read variable index with 0400Ah, increment SS:DBA2h+index byte with
; wraparound.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_grv_increment_variable_part_00 0
    %%fragment_start:
grv_increment_variable:
    %%insn_040f7:
    call grv_read_variable_operand ; 040F7 E810FF
    %if ($ - %%insn_040f7) > 3
        %error "LONG_040F7"
    %endif
