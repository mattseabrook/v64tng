...
; Opcode 34h caller 03C4Ch. Increment DL whenever unsigned variable > decoded element. At sequence
; end jump via [DS:SI] if DL != 0; otherwise skip target. This is per-element comparison, not
; lexicographic comparison; the counter is eight bits.
; Generated losslessly; edit names/comments only after preserving build identity.

%macro emit_grv_branch_sequence_any_greater_part_00 0
    %%fragment_start:
grv_branch_sequence_any_greater:
    %%insn_0421e:
    call grv_read_variable_operand ; 0421E E8E9FD
    %if ($ - %%insn_0421e) > 3
        %error "LONG_0421E"
    %endif
    ...
    %%insn_04228:
    call grv_decode_sequence_element ; 04228 E8EBFD
    %if ($ - %%insn_04228) > 3
        %error "LONG_04228"
    %endif
